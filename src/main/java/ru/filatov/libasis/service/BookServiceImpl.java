...
import ru.filatov.libasis.repository.LibraryRepositoryImpl;
...
public class BookServiceImpl implements BookService {
    ...
    @Autowired
    public BookServiceImpl(BookRepository bookRepository, LibraryRepositoryImpl libraryRepository, PlatformTransactionManager transactionManager)
    {
